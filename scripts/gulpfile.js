...
// rimraf gulp-babel gulp-debug gulp-typescript merge2
// gulp.task('clean', () => {
//     rimraf.sync(distDir);
// });

// function buildCssJs(modules) {
//     gulp.src('src/**/style/index.tsx')
...
//     gulp.src('src/**/style/*.scss').pipe(gulp.dest(modules === false ? esDir : libDir));
