    ...
    return (
        <div className="Button">
            ...
            <div>
                ...
                <Button _inline={true} _size="large" _radius={false} _type="secondary" onClick={onClick}>
            ...
            <br />
            <Button style={{ color: 'rgb(100,200,50)' }} _radius="10px" _ghost={true} onClick={onClick}>
                default|ghost
            </Button>
            <Icon _name="alipay" />
        </div>
