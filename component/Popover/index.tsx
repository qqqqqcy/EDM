...
function recursiveCloneChildren(children: any, cb = (ch: React.ReactChild, _: number) => ch): React.ReactChild[] {
...
export default class Popover extends React.Component<PopOverPropsType, any> {
    ...
    render() {
        ...
        const wrapperNode = <div className={`${this.props.prefixCls}-inner-wrapper`}>{overlayNode}</div>;
